...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'complain-prediction-models', component: ComplainPredictionListComponent },
    { path: 'complains/:complainId/predictions',   component: ComplainDetailPredictionComponent },
    { path: 'prediction-model/:modelId/predictions',   component: ComplainListByModelComponent },
